              ...
              {activeTask === 1 ? (
                <>
                  ...
                  <div>
                    ...
                    <label
                      className={`flex flex-col items-center justify-center gap-2 h-28 border-2 border-dashed rounded-lg cursor-pointer transition-colors ${imageLoading ? "opacity-50 pointer-events-none" : "border-slate-200 hover:border-blue-400 hover:bg-blue-50/40"}`}
                    >
