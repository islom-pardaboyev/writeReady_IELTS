...
const PLANS: SelectedPlan[] = [
  { id: "basic", name: "Basic", price: "19,000", period: "UZS / month", billingNote: "Monthly payment · cancel anytime" },
  { id: "standard", name: "Standard", price: "29,000", period: "UZS / month", billingNote: "Monthly payment · cancel anytime" },
  { id: "premium", name: "Premium", price: "49,000", period: "UZS / month", billingNote: "Monthly payment · cancel anytime" },
];
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="gs-pricing-header text-center mb-14">
            ...
            <p className="text-[var(--text-secondary)] text-[1.0625rem] max-w-[480px] mx-auto">
              Start for free. When you're ready for AI feedback, choose the plan that fits you.
            </p>
          </div>
          ...
          <div className="gs-plans grid grid-cols-[repeat(auto-fit,minmax(240px,1fr))] gap-6 max-w-[1100px] mx-auto">
            ...
            <Card className="gs-plan-card hover:-translate-y-1 hover:shadow-xl transition-all duration-200 p-7 flex flex-col">
              <div className="mb-5">
                ...
                <div className="text-sm text-[var(--text-secondary)]">Start practising for free</div>
              </div>
              <div className="mb-7">
                <span className={`${FONT_MONO} text-3xl font-semibold text-[var(--text-primary)]`}>Free</span>
              </div>
              <ul className="flex flex-col gap-2.5 mb-7 flex-1 text-[0.875rem]">
                <li className="flex items-start gap-2.5 text-[var(--text-primary)]"><span className="text-green-500 font-bold shrink-0 mt-px">✓</span>1 AI analysis (bonus)</li>
                <li className="flex items-start gap-2.5 text-[var(--text-primary)]"><span className="text-green-500 font-bold shrink-0 mt-px">✓</span>All 4 writing modes (Mock, Practice, Quick, Relax)</li>
                <li className="flex items-start gap-2.5 text-[var(--text-primary)]"><span className="text-green-500 font-bold shrink-0 mt-px">✓</span>Question bank</li>
                <li className="flex items-start gap-2.5 text-[var(--text-primary)]"><span className="text-green-500 font-bold shrink-0 mt-px">✓</span>PDF export</li>
              </ul>
            ...
            <Card className="gs-plan-card hover:-translate-y-1 hover:shadow-xl transition-all duration-200 p-7 flex flex-col">
              <div className="mb-5">
                ...
                <div className="text-sm text-[var(--text-secondary)]">Try AI feedback</div>
              </div>
              <div className="mb-7">
                <span className={`${FONT_MONO} text-3xl font-semibold text-[var(--text-primary)]`}>19,000</span>
                <span className="text-sm text-[var(--text-secondary)] ml-1.5">UZS / month</span>
              </div>
              <ul className="flex flex-col gap-2.5 mb-7 flex-1 text-[0.875rem]">
                <li className="flex items-start gap-2.5 text-[var(--text-primary)]"><span className="text-blue-500 font-bold shrink-0 mt-px">✓</span>5 AI analyses / month</li>
                <li className="flex items-start gap-2.5 text-[var(--text-primary)]"><span className="text-blue-500 font-bold shrink-0 mt-px">✓</span>Detailed band score analysis</li>
                <li className="flex items-start gap-2.5 text-[var(--text-primary)]"><span className="text-blue-500 font-bold shrink-0 mt-px">✓</span>Vocabulary flashcards</li>
                <li className="flex items-start gap-2.5 text-[var(--text-primary)]"><span className="text-blue-500 font-bold shrink-0 mt-px">✓</span>Grammar analysis</li>
                <li className="flex items-start gap-2.5 text-[var(--text-primary)]"><span className="text-blue-500 font-bold shrink-0 mt-px">✓</span>PDF export</li>
              </ul>
              <Button
            ...
            <Card className="gs-plan-card hover:-translate-y-1 transition-all duration-200 p-7 flex flex-col relative border-2 border-blue-500 shadow-[0_8px_32px_rgba(59,130,246,0.18)]">
              ...
              <div className="mb-5">
                ...
                <div className="text-sm text-[var(--text-secondary)]">Most popular choice</div>
              </div>
              <div className="mb-7">
              ...
              <ul className="flex flex-col gap-2.5 mb-7 flex-1 text-[0.875rem]">
                <li className="flex items-start gap-2.5 text-[var(--text-primary)]"><span className="text-blue-500 font-bold shrink-0 mt-px">✓</span>12 AI analyses / month</li>
                <li className="flex items-start gap-2.5 text-[var(--text-primary)]"><span className="text-blue-500 font-bold shrink-0 mt-px">✓</span>Everything in Basic</li>
                <li className="flex items-start gap-2.5 text-[var(--text-primary)]"><span className="text-blue-500 font-bold shrink-0 mt-px">✓</span>Sentence-level analysis</li>
                <li className="flex items-start gap-2.5 text-[var(--text-primary)]"><span className="text-blue-500 font-bold shrink-0 mt-px">✓</span>Spelling checker</li>
                <li className="flex items-start gap-2.5 text-[var(--text-primary)]"><span className="text-blue-500 font-bold shrink-0 mt-px">✓</span>Sample responses</li>
              </ul>
              <Button
            ...
            <Card className="gs-plan-card hover:-translate-y-1 hover:shadow-xl transition-all duration-200 p-7 flex flex-col bg-gradient-to-br from-slate-900 to-[#2d1b69] border-purple-700">
              <div className="mb-5">
                ...
                <div className="text-sm text-white/55">All features, maximum analyses</div>
              </div>
              <div className="mb-7">
              ...
              <ul className="flex flex-col gap-2.5 mb-7 flex-1 text-[0.875rem]">
                <li className="flex items-start gap-2.5 text-white/85"><span className="text-purple-300 font-bold shrink-0 mt-px">✓</span>30 AI analyses / month</li>
                <li className="flex items-start gap-2.5 text-white/85"><span className="text-purple-300 font-bold shrink-0 mt-px">✓</span>Everything in Standard</li>
                <li className="flex items-start gap-2.5 text-white/85"><span className="text-purple-300 font-bold shrink-0 mt-px">✓</span>All features</li>
                <li className="flex items-start gap-2.5 text-white/85"><span className="text-purple-300 font-bold shrink-0 mt-px">✓</span>Priority support</li>
              </ul>
              <Button
        ...
        >
          ...
          >
            ...
            <div className="bg-[var(--bg-subtle)] rounded-2xl p-5 mb-7 border border-[var(--border-color)]">
              <div className="flex items-center justify-between gap-4">
                ...
                <div className="text-right">
                  ...
                  <div className={`${FONT_MONO} text-base font-bold text-[var(--text-primary)]`}>{selectedPlan.price} UZS</div>
                </div>
              </div>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-[1.05rem] font-bold text-[var(--text-primary)]">Send payment receipt</h3>
            </div>

            <p className="text-[0.9375rem] text-[var(--text-secondary)] leading-[1.6] mb-5">
              Send a screenshot of the transfer to{" "}
              <strong className="text-[var(--text-primary)]">@{TELEGRAM_USERNAME}</strong> on Telegram. Your{" "}
              {selectedPlan.name} subscription will be activated within 24 hours.
            </p>
